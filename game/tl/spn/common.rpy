...
translate spn strings:
    ...
    new "El final de la historia de este personaje."
    
    old '''Сменить костюм {image=star.png}'''

    new '''un cambio de vestuario. {image=star.png}'''

    old '''{alpha=*0.5}Сменить костюм{/alpha} {image=star.png}'''

    new '''{alpha=*0.5}un cambio de vestuario.{/alpha} {image=star.png}'''

    old '''Сменить костюм'''

    new '''un cambio de vestuario.'''
