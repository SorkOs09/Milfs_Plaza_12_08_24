...
translate eng strings:
    ...
    old "Встретить тебя там же, где и всегда?\n\n"
    new "Meet you where you always are?\n\n"

    old "Анимация Облаков"
    new "Clouds animation"

    old "Наблюдать"
    new "Watch"

    old "Уровень 2 (WIP, будет доступно в 0.9.5)"
    new "Lvl 2 (WIP, will be available in 0.9.5)"



    old "Мыть руки (+50 Гигиена)"
    new "Wash hands (+50 Hygiene)"
